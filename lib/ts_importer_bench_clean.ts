/**
 * Clean Performance Benchmark for TsImporter
 *
 * Compares TsImporter against native import for equivalent functionality
 */
...
Deno.bench({
  name: "Disk Cache Hit - TsImporter",
  group: "disk-cache",
  async fn(b) {
...
console.log("\n💡 Key Metrics:");
console.log("- 'no-imports-cold': Pure overhead of TsImporter");
