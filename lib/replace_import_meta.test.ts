...
describe("replaceImportMeta", () => {
  ...
  it("should replace all import.meta properties in one file", () => {
    ...
    const expectedFilename = Deno.build.os === "windows" ? "\\\\test\\\\dir\\\\file.ts" : "/test/dir/file.ts";
    const expectedDirname = Deno.build.os === "windows" ? "\\\\test\\\\dir" : "/test/dir";
    expect(result).toBe(`
  ...
  it("should handle import.meta properties with whitespace variations", () => {
    const expectedFilename = Deno.build.os === "windows" ? `"\\\\test\\\\file.ts"` : `"/test/file.ts"`;
    const expectedDirname = Deno.build.os === "windows" ? `"\\\\test"` : `"/test"`;
  ...
  it("should handle Windows file URLs for filename and dirname", () => {
    ...
    const expectedDirname = Deno.build.os === "windows" ? "C:\\\\Users\\\\test\\\\project" : "/C:/Users/test/project";
  ...
  it("should handle all import.meta properties and methods together", () => {
    ...
    const expectedFilename = Deno.build.os === "windows" ? "\\\\project\\\\src\\\\main.ts" : "/project/src/main.ts";
    const expectedDirname = Deno.build.os === "windows" ? "\\\\project\\\\src" : "/project/src";
